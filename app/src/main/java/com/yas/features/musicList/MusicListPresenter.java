...
public class MusicListPresenter implements MusicListContract.Presenter {
    ...
    private MusicListContract.View mtView;
    private ContentResolver contentResolver;
    private List<MusicDetail> musicDetails;

    @Inject
    public MusicListPresenter(MyInteractor myInteractor, ContentResolver contentResolver) {
    ...
    public void getMusicList() {
        ...
        final Cursor mCursor = contentResolver.query(
                ...
                new String[]{MediaStore.Audio.Media.TITLE, MediaStore.Audio.Media.DATA, MediaStore.Audio.Media.ARTIST
        ...
        if (mCursor.moveToFirst()) {
            do {
                ...
                music.title = mCursor.getString(mCursor.getColumnIndexOrThrow(MediaStore.Audio.Media.TITLE));
    ...
    @Override
    public void onViewAttached(MusicListContract.View view) {
        this.mtView = (view);
    }
